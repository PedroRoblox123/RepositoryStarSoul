            ...
            <div className={headerDivClasses()}>
                <header className={headerClasses()}>
                    ...
                    <Link to="/" className="image">
                        <img src="../public/starsoul-lettermark-white.svg" alt="StarSoul" />
                    </Link>
                    ...
                    >
                        <ul>
                            ...
                            <li
                                id="aboutthecompany-dropdown"
                                className={`dropdown ${openSubMenus['aboutthecompany-dropdown'] ? 'open' : ''}`}
                                onClick={handleDropdownClick}
                            >
                                Sobre a Empresa <img src="../public/setadown-white.svg" alt="dropdown image" />
                                <ul className="list">
                    ...
                    <div className="midialogo">
                        <img src="../public/starsoul-lettermark.svg" alt="StarSoul" />
                    </div>
                </header>
                ...
                {isSearchBoxVisible && (
                    <div className="search-box-container">
                        <div className="white-arrow" onClick={handleBackClick}>
                            <img src="../public/setadown-white.svg" alt="back" />
                        </div>
